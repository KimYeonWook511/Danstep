...
import NeonButtonComponent from '../neon/NeonButton';
...
const PoseEstimator: React.FC = () => {
  ...
  return (
    <div>
      ...
      {detectedArmsUp ? (
        <div>
          {/* <canvas ref={bgCanvasRef} className="canvas bg-canvas" /> */}
          <video
            ref={camRef}
            className="cam-video"
        ...
        <div>
          <video
            ref={camRef}
            className="cam-video"
            style={{ display: 'none', width: '1280px', height: '960px' }}
            autoPlay
            muted
          />
          <video
